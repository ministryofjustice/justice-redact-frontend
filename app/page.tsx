      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          ...
          <section aria-labelledby="how-it-works-heading">
            <h2 className="govuk-heading-m" id="how-it-works-heading">
              How it works
            </h2>
            ...
            <details className="govuk-details">
              ...
              <div className="govuk-details__text">
                <p className="govuk-body">The AI model will attempt to highlight:</p>
          ...
          <aside className="govuk-inset-text guidance-panel" aria-label="Important guidance">
            <p className="govuk-body">
          ...
          <Link href="/upload" className="govuk-button govuk-button--start" role="button">
            Start now
            <svg
